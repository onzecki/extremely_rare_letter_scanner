...
fn main() {
    println!("▶ {} {}{}{}", "Type".bright_blue().bold(), "anything,".purple().bold(),  " and ERLS will check whether your text contains ".bright_blue().bold(), "rare two-letter combinations!".purple().bold());
